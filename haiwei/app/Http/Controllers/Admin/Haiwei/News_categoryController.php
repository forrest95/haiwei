...
class News_categoryController extends CommonController
{
...
//        return Category::get_categories();
        return view('admin.haiwei.news_categories.index');
    }

    public function create()
    {
        return view('admin.haiwei.news_categories.create');
    }
...
//        return $request->all();
        ...
        return redirect(route('haiwei.news_category.index'))->with('success', '添加栏目成功');
    }

    public function edit($id)
    {
        $category = Category::find($id);
        return view('admin.haiwei.news_categories.edit')->with('category', $category);
    }
    ...
    function update(Request $request, $id)
    {
        ...
        Category::clear();
        return redirect(route('haiwei.news_category.index'))->with('success', '编辑成功~');
    }
