        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <div class="am-tab-panel">
                    ...
                    <form class="am-form " action="/system/update/{{$system->id}}" method="post">
                        {!! csrf_field() !!}
                        {!! method_field('put') !!}
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" class="am-input-sm" name="mobile_phone" value="{{$system->mobile_phone}}">
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" class="am-input-sm" name="telephone" value="{{$system->telephone}}">
                            </div>
                        </div>
