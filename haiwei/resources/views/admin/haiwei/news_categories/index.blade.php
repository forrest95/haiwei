...
@section('content')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新闻栏目管理</strong> /
            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a type="button" class="am-btn am-btn-default" href="{{route('haiwei.news_category.create')}}">
                                    ...
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-xs am-text-secondary"
                                               href="{{route('haiwei.news_category.edit', $category->id)}}">
                                                <span class="am-icon-pencil-square-o"></span> 编辑
                                            </a>

                                            <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                                               href="{{route('haiwei.news_category.destroy', $category->id)}}"
                                               data-method="delete"
    ...
    <script>
        $(function () {
            ...
            $("input[name='sort_order']").change(function () {
                ...
                $.ajax({
                    type: "PATCH",
                    url: "/haiwei/news_category/sort_order",
                    data: data,
                });
            });
            ...
            $(".is_something").click(function () {
                ...
                $.ajax({
                    type: "PATCH",
                    url: "/haiwei/news_category/is_something",
                    data: data,
                    success: function () {
