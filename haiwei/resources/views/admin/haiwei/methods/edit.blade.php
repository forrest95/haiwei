...
@section('content')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑故障解决方法</strong> /
                <small>Edit Methods</small>
            </div>
        </div>
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{ route('haiwei.methods.update', $method->id) }}" method="post">
                    {!! csrf_field() !!}
                    {!! method_field('put') !!}
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <select data-am-selected="{btnWidth: '100%',  btnStyle: 'secondary', btnSize: 'sm', maxHeight: 360, searchBox: 1}"
                                ...
                                @foreach ($products as $product)
                                    <option value="{{ $product->id }}" @if($product->id == $method->product_id) selected @endif>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="text" class="am-input-sm" name="desc" value="{{$method->desc}}">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <textarea rows="4" name="method">{{$method->method}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="radio" name="is_show" value="1"  @if($method->is_show) checked @endif> 是
                            <input type="radio" name="is_show" value="0" @if(!$method->is_show) checked @endif>  否
                        </div>
                    </div>
