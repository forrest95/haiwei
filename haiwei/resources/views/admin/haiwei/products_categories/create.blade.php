...
@section('content')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增产品栏目</strong> /
                <small>Create A Product Category</small>
            </div>
        </div>
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{ route('haiwei.products_category.store') }}" method="post">
                    {!! csrf_field() !!}
