...
@section('content')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑新闻内容</strong> /
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{ route('haiwei.news.update', $xinwen->id) }}" method="post">
                    {!! csrf_field() !!}
                    {!! method_field('put') !!}
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <select data-am-selected="{btnWidth: '100%',  btnStyle: 'secondary', btnSize: 'sm', maxHeight: 360, searchBox: 1}"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" @if($category->id == $xinwen->category_id) selected @endif>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" class="am-input-sm" name="title" value="{{$xinwen->title}}">
                        </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-8 am-u-end col-end">
                            ...
                            <div class="select_thumb">
                                ...
                                <input type="hidden" name="thumb" value="{{$xinwen->thumb}}">
                            </div>

                            <hr data-am-widget="divider" style="" class="am-divider am-divider-dashed" />

                            <div>
                                <img src="{{$xinwen->thumb}}" id="img_show" style="max-height: 200px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top sort">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <textarea rows="4" name="desc">{{$xinwen->desc}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="radio" name="is_top" value="1" @if($xinwen->is_top) checked @endif> 是
                            <input type="radio" name="is_top" value="0" @if(!$xinwen->is_top) checked @endif> 否
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top-sm">
                        <div class="am-u-sm-12 am-u-md-12">
                            <div id="markdown">
                                <textarea rows="10" name="content" style="display:none;">{{$xinwen->content}}</textarea>
                            </div>
                        </div>
                    </div>--}}
